...
function App() {
  const [url, setUrl] = reactExports.useState("https://www.google.com");
  ...
  const assistantIndexRef = reactExports.useRef(null);
  const newsSites = [
  ...
  const loadSite = reactExports.useCallback((siteUrl) => {
    setUrl(siteUrl);
  ...
  const appendAssistantContent = reactExports.useCallback((delta) => {
    if (!delta) return;
  ...
  const handleStreamChunk = reactExports.useCallback(({ requestId, delta }) => {
    if (requestId !== activeRequestIdRef.current) return;
    appendAssistantContent(delta);
  }, [appendAssistantContent]);
  const handleStreamEnd = reactExports.useCallback(({ requestId, response }) => {
    if (requestId !== activeRequestIdRef.current) return;
    setLoading(false);
    setQuery("");
    if (assistantIndexRef.current !== null) {
  ...
  const handleStreamError = reactExports.useCallback(({ requestId, message }) => {
    if (requestId !== activeRequestIdRef.current) return;
    setLoading(false);
    setQuery("");
    setChatHistory((prev) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "browser", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "quick-links", children: newsSites.map((site) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "url-bar", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => loadSite(url), children: "前往" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "webview",
        {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ai-panel", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: "🤖 AI 浏览器助手" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "chat-history", children: [
        chatHistory.map((msg, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `chat-message ${msg.type}`, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "message-label", children: msg.type === "user" ? "👤 您：" : "🤖 助手：" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "message-content", children: msg.content })
        ] }, index)),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ref: chatEndRef })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "query-input", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            type: "text",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: sendQuery, disabled: loading || !query.trim(), children: loading ? "🔄 处理中..." : "▶️ 发送" })
      ] })
    ] })
  ] });
}
